...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="Javascript:Regreso2('Inicio')" class="nav-link">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url('assets/img/loginF.jpg')">
      <div class="container">
        <div class="row">
          <div class="col-md-10 ml-auto mr-auto">
            <div class="card card-signup">
              <h2 class="card-title text-center">Registro Exitoso</h2>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 ml-auto">
                    <div class="info info-horizontal">
                      ...
                      <div class="description">
                          <h3 class="info-title">Tu Folio de registro asignado es :<strong> <s:property value="objFolio.FOLIO"></s:property> </strong></h3>
                      </div>
                    </div>
                    <div class="info info-horizontal">
                      
                      <div class="description text-center">
                        <h4 class="info-title ">Descargar FUR</h4>
                        <p class="description">
                        ...
                        <a href="<s:property value="#myUrl"/>" target="blank">
                            <img style="background-color: white;" src="<s:url value="assets/img/pdf2.png"/>" name="Imprimir" alt="Imprimir" />
                        </a>
                      </p>
                      </div>
                    </div>
