          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card card-timeline card-plain">
                <div class="card-body">
                  <ul class="timeline">
                      <s:iterator value="ListaReq" id="ListaReq" status="stat">  
                          <li>
                              ...
                              <div class="timeline-panel">
                                  <div class="timeline-heading">
                                      <span class="badge badge-pill badge-success"><s:property value="NOM_REQUISITO"/></span>
                                  </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
           ...
           <s:textfield  name="objdatos.ID_BECA_AUX" id="ID_BECA" ></s:textfield> 
      </footer>
    </div>
  </div>
